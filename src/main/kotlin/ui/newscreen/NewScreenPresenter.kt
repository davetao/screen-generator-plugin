...
class NewScreenPresenter(private val view: NewScreenView,
    ...
    fun onOkClick(packageName: String, screenName: String, featureName: String, androidComponent: AndroidComponent, module: String) {
        writeActionDispatcher.dispatch {
            fileCreator.createScreenFiles(packageName, screenName, featureName, androidComponent, module)
        }
        view.close()
    }
}